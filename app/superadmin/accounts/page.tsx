...
export default async function SuperadminAccountsPage() {
  ...
  return (
    <div>
      <h1 className="mb-6 text-3xl font-black text-white">Abonnements</h1>

      {source === "entitlements" ? (
        <div className="mb-6 rounded-xl border border-yellow-400/20 bg-yellow-400/5 p-4">
          <p className="text-sm font-bold text-yellow-300">
            Mode démo — Stripe non configuré. Les données reflètent les plans assignés, pas les paiements réels.
          </p>
        </div>
      ) : (
      ...
      <h2 className="mb-3 text-xl font-black text-white">Abonnements actifs</h2>
