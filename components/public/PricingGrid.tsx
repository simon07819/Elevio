...
const PLANS: PlanProps[] = [
  {
    ...
    price: "199 $",
    period: "/mois",
    description: "Reduce wait times — 1 chantier actif",
    features: [
      "1 chantier actif",
      "2 opérateurs",
      "QR par étage",
  ...
  },
  {
    ...
    price: "499 $",
    period: "/mois",
    description: "Optimize operator performance — dispatch intelligent",
    features: [
      "Jusqu'à 3 chantiers",
      "10 opérateurs",
  ...
  },
  {
    ...
    price: "Sur mesure",
    period: "",
    description: "Prove productivity gains — multi-sites, SLA",
    features: [
      "Chantiers illimités",
