...
import { useCapacitorRedirect } from "@/hooks/useCapacitorRedirect";
...
export function HomeContent() {
  // When running inside Capacitor native shell, redirect to /welcome
  // Web browsers see the landing page as normal.
  const { ready } = useCapacitorRedirect();
